...
const CACHE = "enam-v11-core-header-forecast";
self.addEventListener("install", e => {
  e.waitUntil(caches.open(CACHE).then(c => c.addAll(["./", "./index.html", "./ebook-law-evidence.js", "./manifest.webmanifest", "./icon-192.png"])));
  self.skipWaiting();
});
